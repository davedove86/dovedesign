...
return {
	appDir: "_app",
	appPath: "_app",
	assets: new Set([".DS_Store","android-chrome-192x192.png","android-chrome-256x256.png","apple-touch-icon.png","browserconfig.xml","favicon-16x16.png","favicon-32x32.png","favicon.ico","favicon.png","images/.DS_Store","images/cpm-logo.png","images/cta-banner.jpg","images/design.svg","images/email.svg","images/flowga-portfolio.png","images/footer-logo.svg","images/home-hero.png","images/hosting.svg","images/linkedin-footer.svg","images/linkedin.svg","images/medal.svg","images/nav/logo-only.svg","images/open-graph.jpg","images/pcc-logo.png","images/phone.svg","images/responsive.svg","images/section-image.webp","images/star.svg","images/tick.svg","images/work/cpm-hero.png","images/work/cpm-logo.png","images/work/cpm-portfolio.png","images/work/flowga-portfolio.png","images/work/jb-logo.svg","images/work/jetandben-hero.png","images/work/jetandben-portfolio.png","images/work/pcc-hero.png","images/work/pcc-logo.png","images/work/pcc-portfolio.png","images/work/vcas-hero.png","images/work/vcas-logo.png","images/work/vcas-portfolio.png","mstile-150x150.png","robots.txt","safari-pinned-tab.svg","site.webmanifest"]),
	...
	_: {
		client: {"start":"_app/immutable/entry/start.21c12c31.js","app":"_app/immutable/entry/app.8daea0f2.js","imports":["_app/immutable/entry/start.21c12c31.js","_app/immutable/chunks/scheduler.63274e7e.js","_app/immutable/chunks/singletons.c0a3af09.js","_app/immutable/entry/app.8daea0f2.js","_app/immutable/chunks/scheduler.63274e7e.js","_app/immutable/chunks/index.2226f978.js"],"stylesheets":[],"fonts":[]},
		nodes: [
