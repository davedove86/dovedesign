...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-mxnq71_START -->${$$result.title = `<title>Web Design FAQs | Dove Design Ltd | Answers to Common Website Design
    Questions</title>`, ""}<meta name="description" content="Got questions about web design? Visit Dove Design Ltd's FAQ page for answers to the most common questions about our process, pricing, timeline, and more."><meta property="og:image" content="/images/open-graph.jpg"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:alt" content="Dove Design Ltd"><meta property="og:image:type" content="image/jpeg"><meta property="og:image:secure_url" content="/images/open-graph.jpg"><!-- HEAD_svelte-mxnq71_END -->`, ""} <section><div class="container svelte-lnlf3b"><h1 class="svelte-lnlf3b" data-svelte-h="svelte-w78x8p">FAQs</h1> <div class="grid-col-2 svelte-lnlf3b"></div> ${each(faqData, (faqs) => {
