...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-16sl5ds_START -->${$$result.title = `<title>Durham Police and Crime Commissioner | Dove Design Ltd | Real Client
    Success Stories</title>`, ""}<meta name="description" content="This page showcases the Durham Police and Crime Commissioner website that was build to help the service to offer services to help support people in the community."><meta property="og:image" content="/images/open-graph.jpg"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:alt" content="Dove Design Ltd"><meta property="og:image:type" content="image/jpeg"><meta property="og:image:secure_url" content="/images/open-graph.jpg"><!-- HEAD_svelte-16sl5ds_END -->`, ""} <section><div class="container project-container svelte-1shee8g"><img${add_attribute("src", projects[0].heroImage, 0)} alt="Durham PCC Logo" class="svelte-1shee8g"> <h1 class="project-heading">${escape(projects[0].name)}</h1> <p class="project-description svelte-1shee8g">${escape(projects[0].overview)}</p> <p class="project-description svelte-1shee8g">${escape(projects[0].overviewTwo)}</p> <a${add_attribute("href", projects[0].website, 0)} target="_blank" rel="noopener noreferrer" class="svelte-1shee8g" data-svelte-h="svelte-yod3oz">Visit the Website</a></div> </section>`;
});
export {
  Page as default
};
