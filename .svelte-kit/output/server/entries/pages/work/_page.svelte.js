...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-15whexk_START -->${$$result.title = `<title>Our Web Design Portfolio | Dove Design Ltd | Creative Website Projects &amp;
    Success Stories</title>`, ""}<meta name="description" content="Explore the web design portfolio of Dove Design Ltd, featuring cutting-edge websites for diverse industries. From e-commerce to corporate sites, see how we deliver outstanding digital experiences."><!-- HEAD_svelte-15whexk_END -->`, ""} <section><div class="container"><h1 data-svelte-h="svelte-15p12fn">Our Work</h1> <div class="work-wrapper svelte-gm6unn"></div> ${each(projects, (project) => {
