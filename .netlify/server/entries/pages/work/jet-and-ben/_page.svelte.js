...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1ox3d3t_START -->${$$result.title = `<title>Durham Constabulary Jet &amp; Ben | Dove Design Ltd | Real Client Success
    Stories</title>`, ""}<meta name="description" content="This page showcases the Jet & Ben website that was developed for the Durham Police’s Safety Dogs as they visit educational settings and other community engagement events."><meta property="og:image" content="/images/open-graph.jpg"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:alt" content="Dove Design Ltd"><meta property="og:image:type" content="image/jpeg"><meta property="og:image:secure_url" content="/images/open-graph.jpg"><!-- HEAD_svelte-1ox3d3t_END -->`, ""} <section><div class="container project-container svelte-1cj7szx"><img${add_attribute("src", projects[2].heroImage, 0)} alt="Durham PCC Logo" class="svelte-1cj7szx"> <h1 class="project-heading">${escape(projects[2].name)}</h1> <h2 class="svelte-1cj7szx" data-svelte-h="svelte-1se8v5d">Overview</h2> <p class="project-description svelte-1cj7szx">${escape(projects[2].overview)}</p> <h2 class="svelte-1cj7szx" data-svelte-h="svelte-1lwxwnj">What We Did</h2> <p class="project-description svelte-1cj7szx">${escape(projects[2].whatWeDid)}</p> <h2 class="svelte-1cj7szx" data-svelte-h="svelte-1eudpfj">The Outcome</h2> <p class="project-description svelte-1cj7szx">${escape(projects[2].outcome)}</p> <a${add_attribute("href", projects[2].website, 0)} target="_blank" rel="noopener noreferrer" data-svelte-h="svelte-3sg34i"><button>Visit the website</button></a></div> </section>`;
});
export {
  Page as default
};
