...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-1fs8ev5_START -->${$$result.title = `<title>Our Web Design Portfolio | Dove Design Ltd | Creative Website Projects &amp;
    Success Stories</title>`, ""}<meta name="description" content="Explore the web design portfolio of Dove Design Ltd, featuring cutting-edge websites for diverse industries. From e-commerce to corporate sites, see how we deliver outstanding digital experiences."><meta property="og:image" content="https://dovedesign.io/images/open-graph.jpg"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><meta property="og:image:alt" content="Dove Design Ltd"><meta property="og:image:type" content="image/jpeg"><meta property="og:image:secure_url" content="https://dovedesign.io/images/open-graph.jpg"><!-- HEAD_svelte-1fs8ev5_END -->`, ""} <section><div class="container"><h1 data-svelte-h="svelte-15p12fn">Our Work</h1> <div class="work-wrapper svelte-gm6unn">${each(sortedProjects, (project) => {
    return `<div class="grid-col-2 svelte-gm6unn"><div><img class="portfolio-image svelte-gm6unn"${add_attribute("src", project.image, 0)} alt="${escape(project.name, true) + " website"}"></div> <div><h2 class="svelte-gm6unn">${escape(project.name)}</h2> <div class="tags-wrapper svelte-gm6unn">${each(project.tags, (tag) => {
      return `<div class="tags svelte-gm6unn"><p>${escape(tag)}</p> </div>`;
    })}</div> <p>${escape(project.kicker)}</p> <a${add_attribute("href", project.link, 0)} rel="noopener noreferrer"><button class="svelte-gm6unn" data-svelte-h="svelte-bzxeq">View Project</button> </a></div> </div>`;
  })}</div></div></section> ${validate_component(Testimonials, "Testimonials").$$render($$result, {}, {}, {})}`;
});
export {
  Page as default
};
